<template>
    <div class="projects-manager">
      ...
      <div class="projects-container">
          ...
          <div class="projects-form">
            ...
            <div class="form-group">
              ...
              <div class="tags-input">
                ...
                >
                  <img :src="collab.photoURL || 'https://via.placeholder.com/30'" class="collaborator-avatar" />
                ...
                <div v-if="collabSearchResults.length > 0" class="search-results">
                  <div 
                    ...
                    class="search-result-item"
                  >
                    <img :src="user.photoURL || 'https://via.placeholder.com/30'" class="result-avatar" />
          ...
          <div class="projects-visualization">
            ...
            <div v-if="activeVisualization === 'timeline'" class="timeline-container">
              ...
              <div class="timeline">
                ...
                <div 
                  v-for="project in sortedProjectsByDate" 
                  :key="project.id"
                  class="timeline-item"
            ...
            <div v-if="activeVisualization === 'collaborators'" class="collaborators-chart">
              ...
              <div class="collaborators-list">
                ...
                >
                  <img :src="collab.photoURL || 'https://via.placeholder.com/40'" class="collaborator-avatar" />
                  <div class="collaborator-info">
                    <span class="collaborator-name">{{ collab.displayName || collab.email }}</span>
        ...
        <div class="projects-display-container">
          ...
          <!-- List View -->
          <div v-if="currentView === 'list' && filteredProjects.length > 0" class="projects-table">
            <table>
              <thead>
                <tr>
                ...
                <tr v-for="project in filteredProjects" :key="project.id">
                  ...
                  <td>
                    <div class="collaborators-list">
                      ...
                      >
                        <img 
                          :src="collab.photoURL || 'https://via.placeholder.com/30'" 
  ...
  export default {
    ...
    computed: {
      ...
      progressPercentage() {
        // Calculate progress based on status or custom progress
    ...
    methods: {
      ...
      async saveProject() {
        try {
          ...
          // Clear progress if not in progress
      ...
      async searchTechnologies() {
        if (this.techInput.trim().length > 2) {
          try {
            // In a real app, you would fetch from a technology API
            // For demo, we'll simulate with common technologies
            const commonTechs = [
            ...
            this.techSearchResults = commonTechs.filter(tech => 
              tech.toLowerCase().includes(term)
              .filter(tech => !this.currentProject.technologies.includes(tech))
              .slice(0, 5));
          } catch (error) {
      ...
      handleStatusChange() {
        // When status changes to completed, set end date to today
      ...
      getProjectProgress(project) {
        // Use custom progress if in progress status
      ...
      getTimelinePosition(dateString) {
        ...
        // Find the earliest and latest dates in the projects
        ...
        // If all dates are the same, center them
